...
import 'package:flutter_app/PickCameraPhoto.dart';
...
class _HomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    columns.add(buildRowTitle(context, 'Select Data adding type'));
...
//        )
  ...
  void enterDataManually() async{
    Navigator.push(
      context,
      new MaterialPageRoute(builder: (context) => PickManually()),
    );
  }
